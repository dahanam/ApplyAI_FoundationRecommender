...
while True:
    ...
    cv2.putText(frame, "Mean Skin Color: {}".format(rgb_mean), (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)

    # Display the frame with the mean skin color
    cv2.imshow("Mean Skin Color", frame)
