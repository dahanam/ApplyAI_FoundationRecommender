...
## add a timer to allow for user to align themselves to the square then take a pic
## haley approved this one more than the other one

#after fixing start clustering
#ex: feature test diff parts to check for accuraccy
#then add the k means/ nearest neighbbor
#mayb we could return the top 2 or top 3
